...
void test_small_vectors() {
	...
	test_vec_ctor(L"ABCDE", wchar_input_iter{ 'A' }, wchar_input_iter{ 'Z' });
	...
	test_mutation(L"ABCDE", v.assign(wchar_input_iter{ 'A' }, wchar_input_iter{ 'Z' }));
	...
	test_mutation(L"abABC", v.insert(v.begin() + 2, wchar_input_iter{ 'A' }, wchar_input_iter{ 'Z' }));
